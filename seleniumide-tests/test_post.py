...
class TestPost():
  ...
  def test_post(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".form-group:nth-child(2) > .form-control").send_keys("About")
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".ti-new-tag-input").send_keys("article")
